...
3. Produce two to five materially distinct candidate moves.
...
7. Rank only eligible candidates with the versioned ordinal scorecard.
8. Record the chosen move or an explicit no-move / needs-evidence / blocked-conflict result.
9. Preserve rejected alternatives and evidence that would change the decision.
